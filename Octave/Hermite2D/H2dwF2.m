function [H, Hx, Hy, Hxy, Hxx, Hyy] = H2dwF2(x, y, f, fx, fy, fxy, x0, y0)
...
Fx 	= 	[	
		Hfx(dx(i))		.*		Hf(dy(i));		Hfx(dx(i))		.*		Hf(1-dy(i)); 		Hfx(dx(i))		.*		Hg(dy(i)); 		Hfx(dx(i))		.*		-Hg(1-dy(i));
		...
		Hgx(1-dx(i))	.*		Hf(dy(i));		Hgx(1-dx(i))	.* 		Hf(1-dy(i)); 		Hgx(1-dx(i))	.*		Hg(dy(i));		Hgx(1-dx(i))	.*		-Hg(1-dy(i));
		]./h;
		
Fy 	= 	[	
		Hf(dx(i))		.*		Hfx(dy(i));		Hf(dx(i))		.*		-Hfx(1-dy(i)); 		Hf(dx(i))		.*		Hgx(dy(i)); 	Hf(dx(i))		.*		Hgx(1-dy(i));
		...
		-Hg(1-dx(i))	.*		Hfx(dy(i));		-Hg(1-dx(i))	.* 		-Hfx(1-dy(i)); 		-Hg(1-dx(i))	.*		Hgx(dy(i));		-Hg(1-dx(i))	.*		Hgx(1-dy(i));
		]./h;
		
Fxy = 	[	
		Hfx(dx(i))		.*		Hfx(dy(i));		Hfx(dx(i))		.*		-Hfx(1-dy(i)); 		Hfx(dx(i))		.*		Hgx(dy(i)); 	Hfx(dx(i))		.*		Hgx(1-dy(i));
		-Hfx(1-dx(i))	.*		Hfx(dy(i));		-Hfx(1-dx(i))	.* 		-Hfx(1-dy(i)); 		-Hfx(1-dx(i))	.*		Hgx(dy(i)); 	-Hfx(1-dx(i))	.*		Hgx(1-dy(i));
		Hgx(dx(i))		.*		Hfx(dy(i));		Hgx(dx(i))		.* 		-Hfx(1-dy(i)); 		Hgx(dx(i))		.*		Hgx(dy(i));		Hgx(dx(i))		.*		Hgx(1-dy(i));
		Hgx(1-dx(i))	.*		Hfx(dy(i));		Hgx(1-dx(i))	.* 		-Hfx(1-dy(i)); 		Hgx(1-dx(i))	.*		Hgx(dy(i));		Hgx(1-dx(i))	.*		Hgx(1-dy(i));
		]./(h*h);
		
Fxx = 	[	
		Hfxx(dx(i))		.*		Hf(dy(i));		Hfxx(dx(i))		.*		Hf(1-dy(i)); 		Hfxx(dx(i))		.*		Hg(dy(i)); 		Hfxx(dx(i))		.*		-Hg(1-dy(i));
		Hfxx(1-dx(i))	.*		Hf(dy(i));		Hfxx(1-dx(i))	.* 		Hf(1-dy(i)); 		Hfxx(1-dx(i))	.*		Hg(dy(i)); 		Hfxx(1-dx(i))	.*		-Hg(1-dy(i));
		Hgxx(dx(i))		.*		Hf(dy(i));		Hgxx(dx(i))		.* 		Hf(1-dy(i)); 		Hgxx(dx(i))		.*		Hg(dy(i));		Hgxx(dx(i))		.*		-Hg(1-dy(i));
		-Hgxx(1-dx(i))	.*		Hf(dy(i));		-Hgxx(1-dx(i))	.* 		Hf(1-dy(i)); 		-Hgxx(1-dx(i))	.*		Hg(dy(i));		-Hgxx(1-dx(i))	.*		-Hg(1-dy(i));
		]./(h*h);
		
Fyy = 	[	
		Hf(dx(i))		.*		Hfxx(dy(i));	Hf(dx(i))		.*		Hfxx(1-dy(i)); 		Hf(dx(i))		.*		Hgxx(dy(i)); 	Hf(dx(i))		.*		-Hgxx(1-dy(i));
		Hf(1-dx(i))		.*		Hfxx(dy(i));	Hf(1-dx(i))		.* 		Hfxx(1-dy(i)); 		Hf(1-dx(i))		.*		Hgxx(dy(i)); 	Hf(1-dx(i))		.*		-Hgxx(1-dy(i));
		Hg(dx(i))		.*		Hfxx(dy(i));	Hg(dx(i))		.* 		Hfxx(1-dy(i)); 		Hg(dx(i))		.*		Hgxx(dy(i));	Hg(dx(i))		.*		-Hgxx(1-dy(i));
		-Hg(1-dx(i))	.*		Hfxx(dy(i));	-Hg(1-dx(i))	.* 		Hfxx(1-dy(i)); 		-Hg(1-dx(i))	.*		Hgxx(dy(i));	-Hg(1-dx(i))	.*		-Hgxx(1-dy(i));
		]./(h*h);
