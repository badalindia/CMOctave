function [H, Hx, Hy, Hxy] = H2dw_Full(x, y, f, fx, fy, fxy, x0, y0)
...
F = [	Hf(dx(i)) .* Hf(dy(i)); Hf(dx(i)) .* Hf(1-dy(i)); Hf(dx(i)) .* Hg(dy(i)); Hf(dx(i)) .* -Hg(1-dy(i));
...
Fxy = [	Hfx(dx(i)) .* Hfx(dy(i)); 	Hfx(dx(i)) .* -Hfx(1-dy(i)); 	Hfx(dx(i)) .* Hgx(dy(i)); 	Hfx(dx(i)) .* Hgx(1-dy(i));
		...
		Hgx(1-dx(i)) .* Hfx(dy(i)); Hgx(1-dx(i)) .* -Hfx(1-dy(i)); 	Hgx(1-dx(i)) .* Hgx(dy(i)); Hgx(1-dx(i)) .* Hgx(1-dy(i))]./(h*h);
