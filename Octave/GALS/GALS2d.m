...
while t<tf;
	...
	Q0_xpyp  = H2d(x, y, Q, Qx, Qy, Qxy, x0_xpyp, y0_xpyp);
	Q0_xpyn  = H2d(x, y, Q, Qx, Qy, Qxy, x0_xpyn, y0_xpyn);
	Q0_xnyp  = H2d(x, y, Q, Qx, Qy, Qxy, x0_xnyp, y0_xnyp);
	Q0_xnyn  = H2d(x, y, Q, Qx, Qy, Qxy, x0_xnyn, y0_xnyn);
