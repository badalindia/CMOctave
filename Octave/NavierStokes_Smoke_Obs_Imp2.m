...
%step 1, calculating U*
	...
	%step 1.2, breaking further for adding penalty term in physical space
	Ustar = real( ifft2(Ustar_) )([1:Nc, 1], [1:Nc, 1]);
	Vstar = real( ifft2(Vstar_) )([1:Nc, 1], [1:Nc, 1]);
	
	Ustar2 = Pinv00.*Ustar + Pinv01.*Vstar;
	Vstar2 = Pinv10.*Ustar + Pinv11.*Vstar;
	
	Ustar = Ustar2;
	Vstar = Vstar2;
	
	Ustar_ = fft2(Ustar(1:Nc, 1:Nc));
	Vstar_ = fft2(Vstar(1:Nc, 1:Nc));	
...
%advection of chi
	...
	%advection using fpi
	[x0_xpyp, y0_xpyp] = fpi3UV(Xc, Yc, Xc+eh, Yc+eh, t, dt, U0, U0x, U0y, U0xy, V0, V0x, V0y, V0xy, U0_p, U0x_p, U0y_p, U0xy_p, V0_p, V0x_p, V0y_p, V0xy_p);
	[x0_xpyn, y0_xpyn] = fpi3UV(Xc, Yc, Xc+eh, Yc-eh, t, dt, U0, U0x, U0y, U0xy, V0, V0x, V0y, V0xy, U0_p, U0x_p, U0y_p, U0xy_p, V0_p, V0x_p, V0y_p, V0xy_p);
	[x0_xnyp, y0_xnyp] = fpi3UV(Xc, Yc, Xc-eh, Yc+eh, t, dt, U0, U0x, U0y, U0xy, V0, V0x, V0y, V0xy, U0_p, U0x_p, U0y_p, U0xy_p, V0_p, V0x_p, V0y_p, V0xy_p);
	[x0_xnyn, y0_xnyn] = fpi3UV(Xc, Yc, Xc-eh, Yc-eh, t, dt, U0, U0x, U0y, U0xy, V0, V0x, V0y, V0xy, U0_p, U0x_p, U0y_p, U0xy_p, V0_p, V0x_p, V0y_p, V0xy_p);
